...
export default function ProductDetail() {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem' }}>
      ...
      <button onClick={() => addItem(product)} style={{ padding: '0.8rem 2rem', background: '#059669', color: 'white', border: 'none', borderRadius: '12px', cursor: 'pointer', fontSize: '1rem' }}>افزودن به سبد خرید</button>
    </div>
  );
}
