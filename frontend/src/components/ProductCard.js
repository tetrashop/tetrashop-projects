  ...
  return (
    <div style={{ background: 'white', borderRadius: 16, boxShadow: '0 2px 10px rgba(0,0,0,0.08)', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '1rem' }}>
        ...
        <button onClick={() => addItem(product)} disabled={product.stock === 0} style={{ width: '100%', padding: '0.6rem', background: product.stock === 0 ? '#9ca3af' : '#059669', color: 'white', border: 'none', borderRadius: 8, cursor: product.stock === 0 ? 'default' : 'pointer', fontWeight: 'bold' }}>
