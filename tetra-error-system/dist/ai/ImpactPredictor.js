...
exports.predictFailureImpact = predictFailureImpact;
async function predictFailureImpact(operationName, errorCode) {
    ...
    if (highImpactErrors.includes(errorCode))
        impactScore = 0.9;
    else if (mediumImpactErrors.includes(errorCode))
        impactScore = 0.6;
...
//# sourceMappingURL=ImpactPredictor.js.map