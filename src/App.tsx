...
function App() {
  ...
  const handleApiKeyChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    // فقط برای جلوگیری از خطای TypeScript
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
            ...
            <div className="flex gap-3">
              ...
              <a 
                ...
                onClick={(e) => {
                  e.preventDefault()
                  alert('📚 مستندات API در حالت نمایشی فعال است')
                }}
          ...
          <div className="bg-gradient-to-br from-purple-50 to-white border border-purple-100 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900 mt-2">{totalRequests.toLocaleString('fa-IR')}</p>
              </div>
        ...
        <div className="bg-gradient-to-br from-white to-gray-50 rounded-3xl shadow-lg border border-gray-200 p-6 md:p-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
              ...
              <select className="px-4 py-2.5 border border-gray-300 rounded-xl text-sm bg-white" disabled>
